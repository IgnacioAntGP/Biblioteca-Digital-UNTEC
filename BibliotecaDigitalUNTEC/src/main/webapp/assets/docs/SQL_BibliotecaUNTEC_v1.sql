...
CREATE TABLE IF NOT EXISTS prestamo (
    ...
    estado VARCHAR(20) NOT NULL DEFAULT 'PRESTADO', -- 'PRESTADO', 'DEVUELTO', 'ATRASADO'
    CONSTRAINT fk_prestamo_libro FOREIGN KEY (id_libro) REFERENCES libro(id) ON DELETE CASCADE,
    CONSTRAINT fk_prestamo_usuario FOREIGN KEY (id_usuario) REFERENCES usuario(id) ON DELETE CASCADE
);
